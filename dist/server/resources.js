...
import { findResourceMapping, getAllResourceMappings, } from "./resourceMappings.js";
export const createResources = (server) => {
    const mappings = getAllResourceMappings();
    // Register all resources based on mappings
    for (const mapping of mappings) {
        server.registerResource(`zenblocks:resources:${mapping.filename.replace(".md", "")}`, mapping.uri, {
            title: mapping.title,
