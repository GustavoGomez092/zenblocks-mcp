...
function readVersion() {
    return __awaiter(this, arguments, void 0, function (fallback) {
        var fs, path, fileURLToPath, __filename_1, __dirname_1, candidates, _i, candidates_1, candidate, content, pkg, _a;
        if (fallback === void 0) { fallback = "1.0.0"; }
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    candidates = [
                        path.resolve(__dirname_1, "..", "..", "package.json"),
                        path.resolve(__dirname_1, "..", "package.json"),
                    ...
                    for (_i = 0, candidates_1 = candidates; _i < candidates_1.length; _i++) {
                        ...
                        if (fs.existsSync(candidate)) {
                            ...
                            return [2 /*return*/, pkg.version || fallback];
                        }
                    }
                    return [3 /*break*/, 5];
                case 4:
